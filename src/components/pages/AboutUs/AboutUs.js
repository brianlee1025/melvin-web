  ...
  return (
    <div className="noto-sans-sc aboutUs">
      {width > 768 ? (
        <div>
          <Image
            src={public_img_path + "about_us_1.jpg"}
            fluid
            alt="About Us"
          />
          <div align="center" className="container">
            ...
            <Row>
              <Col md={12} className="aboutUsSectionBody mt-1">
                ...
                <div className="contentPart">
                  <p>
                    Guaranteed to be fresh and of high quality, our products
                    have allowed us to gain trust and confidence
                  </p>
                  <p>
                ...
                <div className="contentPart">
                  <p>
                    We pride ourselves by maintaining products and services of
                    top quality while continuously offering
                  </p>
                  <p>
                    the best products sourced from every continents of the
                    world. At MMT, we do everything to make it easy for you.
                  </p>
                  <p>
              ...
              <Col md={12} className="aboutUsSectionBody mt-1">
                <div className="contentPart">
                  ...
                  <p>
                    ...
                    Manufacturing, Building, Shopping Mall, Cinema, Hotel,
                    Resort
                  </p>
                  <p>
              ...
              <Col md={12} className="aboutUsSectionBody mt-1">
                <div className="contentPart">
                  <p>
                    ...
                    services. We provide international
                  </p>
                  <p>
                    freight forwarding, ocean freight, air freight, and sea
                    freight. Air transport, customs clearance, express delivery
                  </p>
                  <p>
                ...
                <div className="contentPart">
                  <p>
                    We have set up strongholds in Asia, Africa, Australia,
                    Canada, Europe, India , Middle East and USA
                  </p>
                  <p>
                    to deal with customs clearance of import and export
                    shipments. We also one of the major transportation service
                  </p>
            ...
            <Row>
              <Col md={12} className="aboutUsSectionBody">
                <p>
                  ...
                  as frozen food specialist. We are local provider of frozen
                  food and mainly targeting in halal market over the states.
                </p>
                <p>
                  Guaranteed to be fresh and of high quality, our products have
                  allowed us to gain trust and confidence from our customers
                  while building a good reputation for ourselves in this
                  industry.
                </p>

                <p>
                  We pride ourselves by maintaining products and services of top
                  quality while continuously offering the best products sourced
                  from every continents of the world. At MMT, we do everything
                  to make it easy for you. We are a company with the buying
                  power to offer our customer consistently great quality and
          ...
          <div align="center" className="container">
            ...
            <Row>
              <Col md={12} className="aboutUsSectionBody">
                ...
                <p>
                  We offer the best range of cleaning & hygiene solutions to
                  various industries including Hospitality, Cleaning Company,
                  Banking, Retail, Food & Beverage, Manufacturing, Building,
                  Shopping Mall, Cinema, Hotel, Resort and Government Agencies
          ...
          <div align="center" className="container">
            ...
            <Row>
              <Col md={12} className="aboutUsSectionBody">
                <p>
                  In 2020, MMT has expanded its businesses into freight
                  services. We provide international freight forwarding, ocean
                  freight, air freight, and sea freight. Air transport, customs
                  clearance, express delivery and other services, as well as
                  container freight stations established around the world, deal
                  with the receipt, transfer, assembly and disassembly of
                  imported and exported goods.
                </p>
                <p>
                  We have set up strongholds in Asia, Africa, Australia, Canada,
                  Europe, India , Middle East and USA to deal with customs
                  clearance of import and export shipments. We also one of the
                  major transportation service providers in Malaysia for SEA &
                  AIR freight.
                </p>
              </Col>
            </Row>
